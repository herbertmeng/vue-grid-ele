              ...
              <tr>
              {
                this._l(columns, (column, cellIndex) =>
                  <th
                    ...
                    {
                      column.filterable
                         ? <span class="v-table__column-filter-trigger" on-click={ ($event) => this.handleFilterClick($event, column) }><i class={ ['v-icon-arrow-down', column.filterOpened ? 'v-icon-arrow-up' : ''] }></i></span>
                        : ''
                    }
                    </div>
                  </th>
